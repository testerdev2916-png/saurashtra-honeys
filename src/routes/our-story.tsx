...
const HonestIcon = ({
  ...
  >
    ...
    <path
      d="M35,75 C32,80 35,88 45,92 M38,72 C35,78 38,85 46,89 M41,70 C38,75 41,82 48,86"
      strokeWidth="0.3"
    />
    <path
      d="M65,75 C68,80 65,88 55,92 M62,72 C65,78 62,85 54,89 M59,70 C62,75 59,82 52,86"
      strokeWidth="0.3"
    />
    ...
    <path
      d="M44,38 L56,38 M43,42 L57,42 M42,46 L58,46 M42,50 L58,50 M43,54 L57,54 M46,58 L54,58"
      strokeWidth="0.5"
    />
    ...
    <path
      d="M44,22 L46,24 M48,21 L50,23 M52,20 L53,22 M56,22 L54,24 M43,26 L45,26 M57,25 L55,26 M44,29 L46,28 M48,31 L49,29 M52,31 L51,29 M56,28 L54,28"
      strokeWidth="0.5"
    />
...
const ResponsibleIcon = ({
  ...
  >
    ...
    <path
      d="M12,38 C15,45 15,50 12,52 M16,35 C20,42 20,48 17,54 M22,34 C26,40 26,48 23,55"
      strokeWidth="0.75"
    />
    ...
    <path
      d="M26,38 L28,40 M28,36 L30,38 M30,35 L32,37 M26,45 L28,43 M30,48 L32,46 M34,49 L35,47"
      strokeWidth="0.3"
    />
  ...
  head: () => ({
    meta: [
      { title: "Our Story — Saurashtra Honey" },
      {
        name: "description",
        content:
          "From the heart of Saurashtra to your home. Discover our ethical beekeeping and natural farms.",
      },
    ],
  }),
...
function OurStory() {
  ...
  const honeyVarieties = getS("honey_varieties");
  ...
  return (
    <SiteLayout>
      ...
      <main className="bg-[#FDFBF7] text-[#2B2118] overflow-hidden">
        ...
        {/* 4. THE HEART OF EVERYTHING / NATURALLY RIPENED */}
          ...
          <div className="container-page max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-16">
            <div className="w-full md:w-1/2 space-y-10 reveal opacity-0 translate-y-8 transition-all duration-1000">
              <div>
                ...
                <h2 className="font-serif text-[36px] sm:text-[48px] leading-tight text-[#2B2118]">
                  {heart.heading || "Nature creates it. We wait for it."}
                </h2>
              </div>
              ...
              <div className="space-y-8">
                {[
                  {
                    t: heart.feature1_title || "100% Naturally Ripened",
                    d:
                      heart.feature1_desc ||
                      "We harvest honey only after it has naturally ripened inside the hive and the bees have sealed it.",
                  },
                  {
                    t: heart.feature2_title || "Never Rushed",
                    d:
                      heart.feature2_desc ||
                      "We let the bees finish the honey naturally. We never harvest before it is naturally ready.",
                  },
                  {
                    t: heart.feature3_title || "No Artificial Sweetening",
                    d:
                      heart.feature3_desc ||
                      "Zero added sugar or syrup. Just pure nectar transformed by the bees' own natural enzymes.",
                  },
                  {
                    t: heart.feature4_title || "Gentle Care",
                    d:
                      heart.feature4_desc ||
                      "We follow natural, non-invasive beekeeping with minimum intervention.",
                  },
                ].map((item, i) => (
                  <div key={i} className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[14px] text-[#2B2118]/70 leading-relaxed font-light">
                        {item.d}
                      </p>
                    </div>
                  </div>
            ...
            <div className="w-full md:w-1/2 reveal opacity-0 translate-y-8 transition-all duration-1000 delay-150">
              <img
                src={heart.image || honeycombBeesImg}
                alt="Honeycomb"
                className="w-full aspect-[4/3] md:aspect-[4/5] object-cover rounded-[24px]"
              />
            </div>
          </div>
        </section>

        {/* 5. MIGRATORY BEEKEEPING ACROSS GUJARAT */}
        <section className="relative py-32 bg-[#F8F5EF] overflow-hidden">
          <div className="absolute inset-0 opacity-40">
            <img
              src={land.bg_image || heroHoneyImg}
          ...
          <div className="container-page relative z-10 text-center max-w-4xl mx-auto reveal opacity-0 translate-y-8 transition-all duration-1000">
            <span className="text-[11px] uppercase tracking-[0.25em] text-[#3B5241] font-bold block mb-4">
              {land.eyebrow || "NOMADIC BEEKEEPING"}
            </span>
            <h2 className="font-serif text-[44px] md:text-[64px] leading-tight text-[#2B2118] mb-6">
              {land.heading || "Following the Blooms"}
            </h2>
            <p className="text-[18px] md:text-[20px] text-[#2B2118]/80 leading-relaxed font-light max-w-2xl mx-auto mb-16">
              {land.description ||
                "We move our beehives across different districts of Gujarat, chasing the natural flowering crops and seasons to bring you diverse, single-origin honey."}
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-8 md:gap-20">
              {[
                ...
                <div
                  key={i}
                  className="flex flex-col items-center gap-4 reveal opacity-0 translate-y-8 transition-all duration-1000"
                ...
                >
                  ...
                  <span className="text-[11px] uppercase tracking-[0.2em] font-bold text-[#2B2118]">
                    {item.label}
                  </span>
                </div>
              ))}
        ...
        {/* 6. OUR HONEY VARIETIES (NEW) */}
        <section className="py-24 bg-white border-b border-[#2B2118]/5">
          <div className="container-page max-w-6xl mx-auto text-center reveal opacity-0 translate-y-8 transition-all duration-1000">
            <span className="text-[11px] uppercase tracking-[0.25em] text-[#3B5241] font-bold block mb-4">
              {honeyVarieties.eyebrow || "PURE DIVERSITY"}
            </span>
            <h2 className="font-serif text-[36px] sm:text-[48px] leading-tight text-[#2B2118] mb-8">
              {honeyVarieties.heading || "Our Natural Honey Varieties"}
            </h2>
            <p className="text-[16px] md:text-[18px] text-[#2B2118]/70 leading-relaxed font-light max-w-2xl mx-auto mb-12">
              {honeyVarieties.description ||
                "Because we follow the natural blooming seasons across Gujarat, our bees are able to produce several distinct varieties of honey—each with its own unique aroma, taste, and character."}
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-3 md:gap-4 max-w-3xl mx-auto">
              {[
                ...
                <div
                  key={i}
                  className="px-6 py-3 rounded-full border border-[#3B5241]/20 bg-[#FDFBF7] text-[#3B5241] font-medium tracking-wide shadow-sm hover:scale-105 transition-transform cursor-default"
                >
                  {variety}
                </div>
              ))}
          ...
          <div className="container-page max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center gap-16">
            <div className="w-full md:w-1/2 space-y-10 reveal opacity-0 translate-y-8 transition-all duration-1000">
              ...
              <div className="grid grid-cols-2 gap-4 sm:gap-6">
                {[
                  {
                    t: responsible.feature1_title || "Empowering Farmers",
                    d:
                      responsible.feature1_desc ||
                      "We place our hives near farms to support local agriculture and crop yields.",
                  },
                  {
                    t: responsible.feature2_title || "Natural Foraging",
                    d:
                      responsible.feature2_desc ||
                      "Our bees collect nectar safely from natural, suitable environments.",
                  },
                  {
                    t: responsible.feature3_title || "Pollination Heroes",
                    d:
                      responsible.feature3_desc ||
                      "They help pollinate crops naturally, supporting the entire ecosystem.",
                  },
                  {
                    t: responsible.feature4_title || "Healthy Hives",
                    d:
                      responsible.feature4_desc ||
                      "We prioritize the health and strength of every single colony we manage.",
                  },
                ].map((item, i) => (
                  <div
                    key={i}
                    className="bg-[#FDFBF7] p-6 rounded-[16px] border border-[#2B2118]/5 hover:border-[#3B5241]/20 transition-colors"
                  >
                    <Leaf className="size-5 text-[#3B5241] mb-4" strokeWidth={1.5} />
                    <h4 className="font-bold text-[#2B2118] mb-2 text-sm">{item.t}</h4>
                    <p className="text-[13px] text-[#2B2118]/70 leading-relaxed font-light">
                      {item.d}
                    </p>
                  </div>
                ))}
            ...
            <div className="w-full md:w-1/2 reveal opacity-0 translate-y-8 transition-all duration-1000 delay-150">
              <img
                src={responsible.image || beeFarmImg}
                alt="Responsible Beekeeping"
                className="w-full aspect-[4/3] md:aspect-square object-cover rounded-[24px]"
              />
            </div>
          </div>
        </section>
